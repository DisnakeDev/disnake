...
class Menu(disnake.ui.View):
    ...
    async def first_page(self, button: object, inter: disnake.MessageInteraction):
        self.index = 0
        self._update_state()
    ...
    async def prev_page(self, button: object, inter: disnake.MessageInteraction):
        self.index -= 1
        self._update_state()
    ...
    async def remove(self, button: object, inter: disnake.MessageInteraction):
        await inter.response.edit_message(view=None)

    @disnake.ui.button(emoji="▶", style=disnake.ButtonStyle.secondary)
    async def next_page(self, button: object, inter: disnake.MessageInteraction):
        self.index += 1
        self._update_state()
    ...
    @disnake.ui.button(emoji="⏩", style=disnake.ButtonStyle.blurple)
    async def last_page(self, button: object, inter: disnake.MessageInteraction):
