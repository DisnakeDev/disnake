...
class PersistentView(disnake.ui.View):
    ...
    async def green(self, button: disnake.ui.Button, inter: disnake.MessageInteraction) -> None:
    ...
    async def grey(self, button: disnake.ui.Button, inter: disnake.MessageInteraction) -> None:
