...
class PersistentView(disnake.ui.View):
    ...
    async def green(self, button: object, inter: disnake.MessageInteraction):
    ...
    async def red(self, button: object, inter: disnake.MessageInteraction):
    ...
    async def grey(self, button: object, inter: disnake.MessageInteraction):
