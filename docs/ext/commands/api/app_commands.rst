...
- :func:`on_slash_command_error(inter, error) <disnake.on_slash_command_error>`
- :func:`on_slash_command(inter) <disnake.on_slash_command>`
- :func:`on_slash_command_completion(inter) <disnake.on_slash_command_completion>`
- :func:`on_user_command_error(inter, error) <disnake.on_user_command_error>`
- :func:`on_user_command(inter) <disnake.on_user_command>`
- :func:`on_user_command_completion(inter) <disnake.on_user_command_completion>`
- :func:`on_message_command_error(inter, error) <disnake.on_message_command_error>`
- :func:`on_message_command(inter) <disnake.on_message_command>`
- :func:`on_message_command_completion(inter) <disnake.on_message_command_completion>`
