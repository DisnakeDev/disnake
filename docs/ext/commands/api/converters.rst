...
.. _commands_converters:

Converters
==========

This section documents converts - special classes inherited from :class:`Converter` that aid in converting various types to :ref:`discord_model`.
