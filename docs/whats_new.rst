...
- Add :math:`Client.get_global_command`
- Add :math:`Client.get_global_command_named`
- Add :math:`Client.get_guild_application_commands`
- Add :math:`Client.get_guild_slash_commands`
- Add :math:`Client.get_guild_user_commands`
- Add :math:`Client.get_guild_message_commands`
- Add :math:`Client.get_guild_command`
- Add :math:`Client.get_guild_command_named`
