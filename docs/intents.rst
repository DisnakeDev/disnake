...
The intents that are necessary for your bot can only be dictated by yourself. Each attribute in the :class:`Intents` class documents what :ref:`events <discord_api_events>` it corresponds to and what kind of cache it enables.
