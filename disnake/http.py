    ...
    async def request(
        ...
        **kwargs: Any,
        ...
        headers: Dict[str, str] = {
            "User-Agent": self.user_agent,
            # NOTE: that header is temporal until Discord fixes the issue with avatar_decorations
            "x-super-properties": "",
        }
