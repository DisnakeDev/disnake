...
class TextInput(WrappedComponent):
    ...
    def placeholder(self) -> Optional[str]:
        """:class:`str` | ``None``: The placeholder text that is shown if nothing is entered."""
    ...
    def value(self) -> Optional[str]:
        """:class:`str` | ``None``: The pre-filled text of the text input."""
    ...
    def min_length(self) -> Optional[int]:
        """:class:`int` | ``None``: The minimum length of the text input."""
    ...
    def max_length(self) -> Optional[int]:
        """:class:`int` | ``None``: The maximum length of the text input."""
