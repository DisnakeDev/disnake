...
class RawMessageDeleteEvent(_RawReprMixin):
    ...
    cached_message: :class:`Message` | ``None``
...
class RawPollVoteActionEvent(_RawReprMixin):
    ...
    cached_member: :class:`Member` | ``None``
...
class RawReactionActionEvent(_RawReprMixin):
    ...
    message_author_id: :class:`int` | ``None``
...
class RawThreadMemberRemoveEvent(_RawReprMixin):
    ...
    cached_member: :class:`.ThreadMember` | ``None``
