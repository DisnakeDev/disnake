...
class PartialSoundboardSound(Hashable, AssetMixin):
    ...
    def created_at(self) -> Optional[datetime.datetime]:
        """:class:`datetime.datetime` | :obj:`None`: Returns the sound's creation time in UTC.
        Can be :obj:`None` if this is a default sound.
        """
        if self.is_default():
            return None
    ...
    async def edit(
        ...
        *,
        ...
        emoji: :class:`str` | :class:`Emoji` | :class:`PartialEmoji` | :obj:`None`
            The sound's new emoji. Can be :obj:`None`.
