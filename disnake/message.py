...
class DeletedReferencedMessage:
    ...
    def id(self) -> int:
        ...
        return self._parent.message_id  # pyright: ignore[reportReturnType] # type: ignore
...
class Message(Hashable):
    ...
    def __init__(
        ...
        *,
        ...
        self.channel: Union[GuildMessageable, DMChannel, GroupChannel] = channel  # pyright: ignore[reportAttributeAccessIssue] # type: ignore
        ...
        try:
            ...
            self.guild = channel.guild  # pyright: ignore[reportAttributeAccessIssue] # type: ignore
        ...
        if "message_reference" in data:
            ...
            if "referenced_message" in data:
                ...
                if resolved is None:
                    ...
                    ref.resolved = self.__class__(channel=chan, data=resolved, state=state)  # pyright: ignore[reportArgumentType] # type: ignore
        ...
        for handler in ("author", "member", "mentions", "mention_roles"):
            if handler in data:
                getattr(self, f"_handle_{handler}")(data[handler])  # pyright: ignore[reportTypedDictNotRequiredAccess] # type: ignore
    ...
    def _handle_member(self, member: MemberPayload) -> None:
        ...
        try:
            ...
            author._update_from_message(member)  # pyright: ignore[reportAttributeAccessIssue] # type: ignore
        except AttributeError:
            # It's a user here
    ...
    def system_content(self) -> Optional[str]:
        ...
        if self.type is MessageType.guild_stream:
            ...
            return f"{self.author.name} is live! Now streaming {self.author.activity.name}."  # pyright: ignore[reportOptionalMemberAccess, reportAttributeAccessIssue] # type: ignore
        ...
        if self.type is MessageType.thread_starter_message:
            ...
            return self.reference.resolved.content  # pyright: ignore[reportAttributeAccessIssue] # type: ignore
...
class PartialMessage(Hashable):
    ...
    jump_url: str = Message.jump_url  # pyright: ignore[reportAssignmentType] # type: ignore
...
class ForwardedMessage:
    ...
    def __init__(
        ...
        *,
        ...
        self.channel_id: int = channel_id  # pyright: ignore[reportAttributeAccessIssue] # type: ignore
        self.attachments: List[Attachment] = [
