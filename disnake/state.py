...
from disnake.components import _SELECT_COMPONENT_TYPES
...
if TYPE_CHECKING:
    ...
    from disnake.abc import AnyChannel, MessageableChannel, PrivateChannel
    ...
    from disnake.types.soundboard import GuildSoundboardSound as GuildSoundboardSoundPayload
