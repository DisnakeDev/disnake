...
def parse_args(check=True):
    ...
    """
    parser = optparse.OptionParser(version=nodeenv_version, usage="%prog [OPTIONS] ENV_DIR")
...
def install_node_wrapped(env_dir, src_dir, opt):
    ...
    logger.info(" * Install %s node (%s) " % (src_type, opt.node), extra=dict(continued=True))
